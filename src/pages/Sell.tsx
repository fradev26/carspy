              ...
              <div className="space-y-4">
                ...
                {analysisLoading && (
                  <div
                    ...
                    aria-busy="true"
                  >
                    <Loader2 className="h-8 w-8 animate-spin text-primary-strong" aria-hidden="true" />
                ...
                {analysisResult && (
                  <div className={cn('space-y-4', isAnalysisStale && 'opacity-60')}>
                    {analysisResult.suggestedPrice > 0 && (
                      <div className="rounded-lg bg-primary/5 border border-primary/20 p-4 space-y-3">
                        ...
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-bold text-primary-strong">€ {analysisResult.suggestedPrice.toLocaleString('nl-BE')}</span>
                        </div>
                    ...
                    <div className="flex items-start gap-3 rounded-lg bg-primary/5 border border-primary/20 p-4">
                      <ShieldCheck className="h-5 w-5 text-primary-strong shrink-0 mt-0.5" />
                      <div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 rounded-xl border border-border/60 bg-muted/20 p-4">
                ...
                <label className="flex items-start gap-3 text-sm cursor-pointer">
                  ...
                  <span>Ik ga akkoord met de <a href="/privacy" className="text-primary-strong underline">privacyvoorwaarden</a>.</span>
                </label>
              </div>
            </div>
          )}
